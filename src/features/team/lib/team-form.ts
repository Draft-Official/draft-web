...
const TEAM_CODE_SPECIAL_CHAR_REGEX = /[^A-Za-z0-9가-힣ㄱ-ㅎㅏ-ㅣ]/g;
...
export function sanitizeTeamCode(value: string): string {
  return value
    .replace(TEAM_CODE_SPECIAL_CHAR_REGEX, '')
    .slice(0, TEAM_CODE_MAX_LENGTH);
}
