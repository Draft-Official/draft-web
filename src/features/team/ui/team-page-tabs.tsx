    ...
    <div className="min-h-screen bg-background">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full gap-0">
        ...
        <div className="bg-white sticky top-0 z-20 px-(--dimension-spacing-x-global-gutter) py-(--dimension-x2)">
          <TabsList>
            <TabsTrigger value="my-teams" className="relative font-bold text-base after:hidden">
              나의 팀
              {activeTab === 'my-teams' && (
                <motion.div
            ...
            <TabsTrigger value="create-team" className="relative font-bold text-base after:hidden">
