    ...
    <section className="bg-white px-5 py-6 space-y-6">
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
                <span className={cn("text-sm font-bold", !isPositionMode ? "text-slate-800" : "text-slate-400")}>포지션 무관</span>
                <Switch 
                ...
                />
                <span className={cn("text-sm font-bold", isPositionMode ? "text-slate-800" : "text-slate-400")}>포지션별</span>
            </div>
        </div>
