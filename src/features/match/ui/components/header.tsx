    ...
    >
      <div className="flex items-center justify-between px-4 h-14 w-full bg-white">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/matches/create"
            className="lg:hidden px-3 py-1.5 bg-primary text-white text-xs font-bold rounded-full shadow-sm hover:bg-primary/90 active:scale-95 transition-all mr-1"
          >
            경기 개설하기
          </Link>
