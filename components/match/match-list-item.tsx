...
export function MatchListItem(props: MatchListItemProps) {
    ...
    return (
        <Card 
            className={cn(
                "border-none shadow-sm active:scale-[0.98] transition-all duration-150 cursor-pointer overflow-hidden ring-1 ring-slate-100 hover:ring-slate-200 hover:shadow-md",
